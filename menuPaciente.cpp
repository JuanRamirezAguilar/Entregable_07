...
void menuPaciente::menu() {
    ...
    do {
        ...
        gotoxy(3, 9);
        std::cout <<GB; std::cout << "Agregar un Paciente.         [ " <<RF<< "A" <<GB " ]";
        gotoxy(3, 10);
        std::cout <<GB; std::cout << "Elimnar un Paciente.         [ " <<RF<< "B" <<GB " ]";
        gotoxy(3, 11);
        std::cout <<GB; std::cout << "Buscar un Paciente.          [ " <<RF<< "C" <<GB " ]";
        gotoxy(3, 12);
...
void menuPaciente::importarArchivo() {
    miArchivoPaciente.importBackup();
}